...
mod _erlang_line_classifier_framec {
    ...
    impl ErlangLineClassifier {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(ErlangLineClassifierFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> ErlangLineClassifierCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<ErlangLineClassifierFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(ErlangLineClassifierFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(ErlangLineClassifierFrameEvent::FrameEnter {});
