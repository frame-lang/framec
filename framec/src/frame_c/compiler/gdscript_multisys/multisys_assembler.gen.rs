...
mod _g_d_script_multi_sys_assembler_fsm_framec {
    ...
    struct GDScriptMultiSysAssemblerFsmFrameContext {
        event: alloc::rc::Rc<GDScriptMultiSysAssemblerFsmFrameEvent>,
        _return: Option<GDScriptMultiSysAssemblerFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, GDScriptMultiSysAssemblerFsmFrameValue>,
        _transitioned: bool,
    }

    impl GDScriptMultiSysAssemblerFsmFrameContext {
        fn new(event: alloc::rc::Rc<GDScriptMultiSysAssemblerFsmFrameEvent>, default_return: Option<GDScriptMultiSysAssemblerFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl GDScriptMultiSysAssemblerFsm {
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<GDScriptMultiSysAssemblerFsmFrameEvent>) {
        ...
        pub fn wrap_inner(&mut self, name: String) {
            let __e = alloc::rc::Rc::new(GDScriptMultiSysAssemblerFsmFrameEvent::WrapInner { name: name.clone() });
            let mut __ctx = GDScriptMultiSysAssemblerFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _g_d_script_multi_sys_assembler_fsm_framec::*;
