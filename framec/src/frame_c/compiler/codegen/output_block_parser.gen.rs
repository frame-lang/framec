...
mod _output_block_parser_fsm_framec {
    ...
    impl OutputBlockParserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(OutputBlockParserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> OutputBlockParserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<OutputBlockParserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(OutputBlockParserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(OutputBlockParserFsmFrameEvent::FrameEnter { args: enter_args });
