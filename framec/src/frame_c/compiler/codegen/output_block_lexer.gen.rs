...
mod _output_block_lexer_fsm_framec {
    ...
    impl OutputBlockLexerFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> OutputBlockLexerFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<OutputBlockLexerFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::FrameEnter {});
