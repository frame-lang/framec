...
mod _output_block_lexer_fsm_framec {
    ...
    struct OutputBlockLexerFsmFrameContext {
        event: alloc::rc::Rc<OutputBlockLexerFsmFrameEvent>,
        _return: Option<OutputBlockLexerFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, OutputBlockLexerFsmFrameValue>,
        _transitioned: bool,
    }

    impl OutputBlockLexerFsmFrameContext {
        fn new(event: alloc::rc::Rc<OutputBlockLexerFsmFrameEvent>, default_return: Option<OutputBlockLexerFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl OutputBlockLexerFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = OutputBlockLexerFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<OutputBlockLexerFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<OutputBlockLexerFsmFrameEvent>) {
        ...
        pub fn do_lex(&mut self) {
            let __e = alloc::rc::Rc::new(OutputBlockLexerFsmFrameEvent::DoLex {});
            let mut __ctx = OutputBlockLexerFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _output_block_lexer_fsm_framec::*;
