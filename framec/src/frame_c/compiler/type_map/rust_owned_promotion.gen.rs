...
mod _rust_owned_promotion_framec {
    ...
    struct RustOwnedPromotionFrameContext {
        event: std::rc::Rc<RustOwnedPromotionFrameEvent>,
        _return: Option<RustOwnedPromotionFrameReturn>,
        _data: std::collections::HashMap<String, RustOwnedPromotionFrameValue>,
        _transitioned: bool,
    }

    impl RustOwnedPromotionFrameContext {
        fn new(event: std::rc::Rc<RustOwnedPromotionFrameEvent>, default_return: Option<RustOwnedPromotionFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl RustOwnedPromotion {
        ...
        pub fn __create() -> Self {
            ...
            let __e = std::rc::Rc::new(RustOwnedPromotionFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = RustOwnedPromotionFrameContext::new(std::rc::Rc::clone(&__e), None);
        ...
        fn __kernel(&mut self, __e: &std::rc::Rc<RustOwnedPromotionFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = std::rc::Rc::new(RustOwnedPromotionFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = std::rc::Rc::new(RustOwnedPromotionFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &std::rc::Rc<RustOwnedPromotionFrameEvent>) {
        ...
        pub fn promote(&mut self, t: String) -> String {
            let __e = std::rc::Rc::new(RustOwnedPromotionFrameEvent::Promote { t: t.clone() });
            let mut __ctx = RustOwnedPromotionFrameContext::new(std::rc::Rc::clone(&__e), None);
