...
mod _rust_dispatch_convert_framec {
    ...
    impl RustDispatchConvert {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(RustDispatchConvertFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> RustDispatchConvertCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<RustDispatchConvertFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(RustDispatchConvertFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(RustDispatchConvertFrameEvent::FrameEnter {});
