...
mod _go_map_type_framec {
    ...
    struct GoMapTypeFrameContext {
        event: std::rc::Rc<GoMapTypeFrameEvent>,
        _return: Option<GoMapTypeFrameReturn>,
        _data: std::collections::HashMap<String, GoMapTypeFrameValue>,
        _transitioned: bool,
    }

    impl GoMapTypeFrameContext {
        fn new(event: std::rc::Rc<GoMapTypeFrameEvent>, default_return: Option<GoMapTypeFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl GoMapType {
        ...
        pub fn __create() -> Self {
            ...
            let __e = std::rc::Rc::new(GoMapTypeFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = GoMapTypeFrameContext::new(std::rc::Rc::clone(&__e), None);
        ...
        fn __kernel(&mut self, __e: &std::rc::Rc<GoMapTypeFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = std::rc::Rc::new(GoMapTypeFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = std::rc::Rc::new(GoMapTypeFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &std::rc::Rc<GoMapTypeFrameEvent>) {
        ...
        pub fn map(&mut self, t: String) -> String {
            let __e = std::rc::Rc::new(GoMapTypeFrameEvent::Map { t: t.clone() });
            let mut __ctx = GoMapTypeFrameContext::new(std::rc::Rc::clone(&__e), None);
