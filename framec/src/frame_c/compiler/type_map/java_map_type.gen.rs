...
mod _java_map_type_framec {
    ...
    impl JavaMapTypeCompartment {
        fn new(state: &str) -> Self {
            let state_context = match state {
                ...
                _ => JavaMapTypeStateContext::__NoContext,
            };
            Self {
    ...
    impl JavaMapType {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(JavaMapTypeFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> JavaMapTypeCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<JavaMapTypeFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(JavaMapTypeFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(JavaMapTypeFrameEvent::FrameEnter {});
