...
mod _cpp_map_type_framec {
    ...
    impl CppMapType {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(CppMapTypeFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> CppMapTypeCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<CppMapTypeFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(CppMapTypeFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(CppMapTypeFrameEvent::FrameEnter { args: enter_args });
