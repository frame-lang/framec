...
mod _frame_structural_body_closer_fsm_framec {
    ...
    struct FrameStructuralBodyCloserFsmFrameContext {
        event: std::rc::Rc<FrameStructuralBodyCloserFsmFrameEvent>,
        _return: Option<FrameStructuralBodyCloserFsmFrameReturn>,
        _data: std::collections::HashMap<String, FrameStructuralBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl FrameStructuralBodyCloserFsmFrameContext {
        fn new(event: std::rc::Rc<FrameStructuralBodyCloserFsmFrameEvent>, default_return: Option<FrameStructuralBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl FrameStructuralBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = std::rc::Rc::new(FrameStructuralBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = FrameStructuralBodyCloserFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<String>) -> FrameStructuralBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &std::rc::Rc<FrameStructuralBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = std::rc::Rc::new(FrameStructuralBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = std::rc::Rc::new(FrameStructuralBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &std::rc::Rc<FrameStructuralBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = std::rc::Rc::new(FrameStructuralBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = FrameStructuralBodyCloserFsmFrameContext::new(std::rc::Rc::clone(&__e), None);
