...
mod _ts_body_closer_fsm_framec {
    ...
    impl TsBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> TsBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<TsBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::FrameEnter {});
