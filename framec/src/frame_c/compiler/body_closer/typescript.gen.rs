...
mod _ts_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct TsBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<TsBodyCloserFsmFrameEvent>,
        _return: Option<TsBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, TsBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl TsBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<TsBodyCloserFsmFrameEvent>, default_return: Option<TsBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl TsBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = TsBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> TsBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<TsBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<TsBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(TsBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = TsBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _ts_body_closer_fsm_framec::*;
