...
mod _ruby_body_closer_fsm_framec {
    ...
    struct RubyBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<RubyBodyCloserFsmFrameEvent>,
        _return: Option<RubyBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, RubyBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl RubyBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<RubyBodyCloserFsmFrameEvent>, default_return: Option<RubyBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl RubyBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(RubyBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = RubyBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<RubyBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(RubyBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(RubyBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<RubyBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(RubyBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = RubyBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _ruby_body_closer_fsm_framec::*;
