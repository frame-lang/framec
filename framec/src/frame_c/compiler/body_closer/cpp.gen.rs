...
mod _cpp_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    #[derive(Clone, Debug)]
    ...
    struct CppBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<CppBodyCloserFsmFrameEvent>,
        _return: Option<CppBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, CppBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl CppBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<CppBodyCloserFsmFrameEvent>, default_return: Option<CppBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl CppBodyCloserFsm {
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<CppBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(CppBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = CppBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _cpp_body_closer_fsm_framec::*;
