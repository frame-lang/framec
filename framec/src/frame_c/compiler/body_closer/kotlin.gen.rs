...
mod _kotlin_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct KotlinBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<KotlinBodyCloserFsmFrameEvent>,
        _return: Option<KotlinBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, KotlinBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl KotlinBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<KotlinBodyCloserFsmFrameEvent>, default_return: Option<KotlinBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl KotlinBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = KotlinBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<KotlinBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<KotlinBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = KotlinBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _kotlin_body_closer_fsm_framec::*;
