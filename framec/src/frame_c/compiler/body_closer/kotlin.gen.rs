...
mod _kotlin_body_closer_fsm_framec {
    ...
    impl KotlinBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> KotlinBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<KotlinBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(KotlinBodyCloserFsmFrameEvent::FrameEnter {});
