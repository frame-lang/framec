...
mod _python_body_closer_fsm_framec {
    ...
    impl PythonBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> PythonBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<PythonBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::FrameEnter {});
            ...
            while self.pos < n {
                ...
                if b == b'\n' {
                    ...
                    if self.pos + 2 < n && self.bytes[self.pos + 1] == q && self.bytes[self.pos + 2] == q {
                        self.quote_char = q;
                        self.pos += 3;
                        let mut __compartment = self.__prepareEnter("InTripleString");
                        self.__transition(__compartment);
                        return;
                    } else {
                        self.quote_char = q;
