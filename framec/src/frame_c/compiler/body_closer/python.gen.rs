...
mod _python_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct PythonBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<PythonBodyCloserFsmFrameEvent>,
        _return: Option<PythonBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, PythonBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl PythonBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<PythonBodyCloserFsmFrameEvent>, default_return: Option<PythonBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl PythonBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = PythonBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> PythonBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<PythonBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<PythonBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(PythonBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = PythonBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _python_body_closer_fsm_framec::*;
