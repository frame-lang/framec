...
mod _lua_body_closer_fsm_framec {
    ...
    impl LuaBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> LuaBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<LuaBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::FrameEnter {});
        ...
        fn _s_Scanning_hdl_frame_enter(&mut self, __e: &LuaBodyCloserFsmFrameEvent) {
            ...
            while self.pos < n {
                ...
                if b == b'\n' {
                    ...
                    // Long string [[ ]]
                    self.pos += 2;
                    let mut __compartment = self.__prepareEnter("InLongString");
                    self.__transition(__compartment);
                    return;
                } else if b == b'{' {
                    self.depth += 1;
