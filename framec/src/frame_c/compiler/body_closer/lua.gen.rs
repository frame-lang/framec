...
mod _lua_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct LuaBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<LuaBodyCloserFsmFrameEvent>,
        _return: Option<LuaBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, LuaBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl LuaBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<LuaBodyCloserFsmFrameEvent>, default_return: Option<LuaBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl LuaBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = LuaBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> LuaBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<LuaBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<LuaBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(LuaBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = LuaBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _lua_body_closer_fsm_framec::*;
