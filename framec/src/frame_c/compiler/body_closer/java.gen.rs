...
mod _java_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct JavaBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<JavaBodyCloserFsmFrameEvent>,
        _return: Option<JavaBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, JavaBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl JavaBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<JavaBodyCloserFsmFrameEvent>, default_return: Option<JavaBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl JavaBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(JavaBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = JavaBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> JavaBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<JavaBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(JavaBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(JavaBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<JavaBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(JavaBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = JavaBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _java_body_closer_fsm_framec::*;
