...
mod _cs_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct CsBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<CsBodyCloserFsmFrameEvent>,
        _return: Option<CsBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, CsBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl CsBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<CsBodyCloserFsmFrameEvent>, default_return: Option<CsBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl CsBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(CsBodyCloserFsmFrameEvent::FrameEnter {});
            let __ctx = CsBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> CsBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<CsBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(CsBodyCloserFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(CsBodyCloserFsmFrameEvent::FrameEnter {});
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<CsBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(CsBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = CsBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn _s_Scanning_hdl_frame_enter(&mut self, __e: &CsBodyCloserFsmFrameEvent) {
            ...
            while self.pos < n {
                ...
                if b == b'\n' {
                    ...
                    self.pos += 1;
                    let mut __compartment = self.__prepareEnter("InPreprocessor");
                    self.__transition(__compartment);
                    return;
                } else if b == b'\'' {
                    self.pos += 1;
                    ...
                    if self.pos + 1 < n && self.bytes[self.pos + 1] == b'"' {
                        self.pos += 2;
                        let mut __compartment = self.__prepareEnter("InVerbatimString");
                        self.__transition(__compartment);
                        return;
...
pub use _cs_body_closer_fsm_framec::*;
