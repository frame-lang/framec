...
mod _go_body_closer_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct GoBodyCloserFsmFrameContext {
        event: alloc::rc::Rc<GoBodyCloserFsmFrameEvent>,
        _return: Option<GoBodyCloserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, GoBodyCloserFsmFrameValue>,
        _transitioned: bool,
    }

    impl GoBodyCloserFsmFrameContext {
        fn new(event: alloc::rc::Rc<GoBodyCloserFsmFrameEvent>, default_return: Option<GoBodyCloserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl GoBodyCloserFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(GoBodyCloserFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = GoBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> GoBodyCloserFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<GoBodyCloserFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(GoBodyCloserFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(GoBodyCloserFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<GoBodyCloserFsmFrameEvent>) {
        ...
        pub fn scan(&mut self) {
            let __e = alloc::rc::Rc::new(GoBodyCloserFsmFrameEvent::Scan {});
            let mut __ctx = GoBodyCloserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _go_body_closer_fsm_framec::*;
