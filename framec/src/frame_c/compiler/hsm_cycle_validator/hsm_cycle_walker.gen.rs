...
mod _hsm_cycle_walker_framec {
    ...
    struct HsmCycleWalkerFrameContext {
        event: std::rc::Rc<HsmCycleWalkerFrameEvent>,
        _return: Option<HsmCycleWalkerFrameReturn>,
        _data: std::collections::HashMap<String, HsmCycleWalkerFrameValue>,
        _transitioned: bool,
    }

    impl HsmCycleWalkerFrameContext {
        fn new(event: std::rc::Rc<HsmCycleWalkerFrameEvent>, default_return: Option<HsmCycleWalkerFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl HsmCycleWalker {
        ...
        pub fn __create() -> Self {
            ...
            let __e = std::rc::Rc::new(HsmCycleWalkerFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = HsmCycleWalkerFrameContext::new(std::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<String>) -> HsmCycleWalkerCompartment {
        ...
        fn __kernel(&mut self, __e: &std::rc::Rc<HsmCycleWalkerFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = std::rc::Rc::new(HsmCycleWalkerFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = std::rc::Rc::new(HsmCycleWalkerFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &std::rc::Rc<HsmCycleWalkerFrameEvent>) {
        ...
        pub fn step(&mut self, parent: String) -> String {
            let __e = std::rc::Rc::new(HsmCycleWalkerFrameEvent::Step { parent: parent.clone() });
            let mut __ctx = HsmCycleWalkerFrameContext::new(std::rc::Rc::clone(&__e), None);
        ...
        fn _s_Walking_hdl_user_step(&mut self, __e: &HsmCycleWalkerFrameEvent, parent: String) {
                            if parent.is_empty() {
                                let mut __compartment = self.__prepareEnter("ChainRoot", vec![]);
                                self.__transition(__compartment);
            let __return_val = HsmCycleWalkerFrameReturn::Step("ROOT".to_string());
                            ...
                            if already_seen {
                                ...
                                let mut __compartment = self.__prepareEnter("CycleFound", vec![]);
                                self.__transition(__compartment);
