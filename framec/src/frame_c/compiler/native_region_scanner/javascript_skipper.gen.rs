...
mod _java_script_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct JavaScriptSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<JavaScriptSyntaxSkipperFsmFrameEvent>,
        _return: Option<JavaScriptSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, JavaScriptSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl JavaScriptSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<JavaScriptSyntaxSkipperFsmFrameEvent>, default_return: Option<JavaScriptSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl JavaScriptSyntaxSkipperFsmCompartment {
        fn new(state: &str) -> Self {
            let state_context = match state {
                ...
                _ => JavaScriptSyntaxSkipperFsmStateContext::__NoContext,
            };
            Self {
    ...
    impl JavaScriptSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::FrameEnter {});
            let __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> JavaScriptSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<JavaScriptSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::FrameEnter {});
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<JavaScriptSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(JavaScriptSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = JavaScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _java_script_syntax_skipper_fsm_framec::*;
