...
mod _ruby_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct RubySyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<RubySyntaxSkipperFsmFrameEvent>,
        _return: Option<RubySyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, RubySyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl RubySyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<RubySyntaxSkipperFsmFrameEvent>, default_return: Option<RubySyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl RubySyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = RubySyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> RubySyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<RubySyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<RubySyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = RubySyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = RubySyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = RubySyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(RubySyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = RubySyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _ruby_syntax_skipper_fsm_framec::*;
