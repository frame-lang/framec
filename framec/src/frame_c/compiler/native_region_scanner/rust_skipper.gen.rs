...
mod _rust_syntax_skipper_fsm_framec {
    ...
    impl RustSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<RustSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
