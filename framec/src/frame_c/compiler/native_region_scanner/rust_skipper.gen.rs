...
mod _rust_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct RustSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<RustSyntaxSkipperFsmFrameEvent>,
        _return: Option<RustSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, RustSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl RustSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<RustSyntaxSkipperFsmFrameEvent>, default_return: Option<RustSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl RustSyntaxSkipperFsmCompartment {
        fn new(state: &str) -> Self {
            let state_context = match state {
                ...
                _ => RustSyntaxSkipperFsmStateContext::__NoContext,
            };
            Self {
    ...
    impl RustSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::FrameEnter {});
            let __ctx = RustSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> RustSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<RustSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::FrameEnter {});
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<RustSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = RustSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = RustSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = RustSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(RustSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = RustSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _rust_syntax_skipper_fsm_framec::*;
