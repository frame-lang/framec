...
mod _type_script_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct TypeScriptSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<TypeScriptSyntaxSkipperFsmFrameEvent>,
        _return: Option<TypeScriptSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, TypeScriptSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl TypeScriptSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<TypeScriptSyntaxSkipperFsmFrameEvent>, default_return: Option<TypeScriptSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl TypeScriptSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> TypeScriptSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<TypeScriptSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<TypeScriptSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = TypeScriptSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _type_script_syntax_skipper_fsm_framec::*;
