...
mod _type_script_syntax_skipper_fsm_framec {
    ...
    impl TypeScriptSyntaxSkipperFsmCompartment {
        fn new(state: &str) -> Self {
            let state_context = match state {
                ...
                _ => TypeScriptSyntaxSkipperFsmStateContext::__NoContext,
            };
            Self {
    ...
    impl TypeScriptSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> TypeScriptSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<TypeScriptSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(TypeScriptSyntaxSkipperFsmFrameEvent::FrameEnter {});
