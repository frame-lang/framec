...
mod _c_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct CSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<CSyntaxSkipperFsmFrameEvent>,
        _return: Option<CSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, CSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl CSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<CSyntaxSkipperFsmFrameEvent>, default_return: Option<CSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl CSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = CSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> CSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<CSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<CSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = CSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = CSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = CSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(CSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = CSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _c_syntax_skipper_fsm_framec::*;
