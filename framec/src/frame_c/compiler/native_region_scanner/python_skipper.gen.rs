...
mod _python_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct PythonSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<PythonSyntaxSkipperFsmFrameEvent>,
        _return: Option<PythonSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, PythonSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl PythonSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<PythonSyntaxSkipperFsmFrameEvent>, default_return: Option<PythonSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl PythonSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = PythonSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> PythonSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<PythonSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<PythonSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = PythonSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = PythonSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = PythonSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = PythonSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _python_syntax_skipper_fsm_framec::*;
