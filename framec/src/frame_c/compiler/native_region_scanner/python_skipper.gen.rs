...
mod _python_syntax_skipper_fsm_framec {
    ...
    impl PythonSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> PythonSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<PythonSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(PythonSyntaxSkipperFsmFrameEvent::FrameEnter {});
