...
mod _erlang_scope_scanner_fsm_framec {
    ...
    struct ErlangScopeScannerFsmFrameContext {
        event: alloc::rc::Rc<ErlangScopeScannerFsmFrameEvent>,
        _return: Option<ErlangScopeScannerFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, ErlangScopeScannerFsmFrameValue>,
        _transitioned: bool,
    }

    impl ErlangScopeScannerFsmFrameContext {
        fn new(event: alloc::rc::Rc<ErlangScopeScannerFsmFrameEvent>, default_return: Option<ErlangScopeScannerFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl ErlangScopeScannerFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(ErlangScopeScannerFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = ErlangScopeScannerFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> ErlangScopeScannerFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<ErlangScopeScannerFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(ErlangScopeScannerFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(ErlangScopeScannerFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<ErlangScopeScannerFsmFrameEvent>) {
        ...
        pub fn do_scan(&mut self) {
            let __e = alloc::rc::Rc::new(ErlangScopeScannerFsmFrameEvent::DoScan {});
            let mut __ctx = ErlangScopeScannerFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _erlang_scope_scanner_fsm_framec::*;
