...
mod _state_var_parser_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct StateVarParserFsmFrameContext {
        event: alloc::rc::Rc<StateVarParserFsmFrameEvent>,
        _return: Option<StateVarParserFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, StateVarParserFsmFrameValue>,
        _transitioned: bool,
    }

    impl StateVarParserFsmFrameContext {
        fn new(event: alloc::rc::Rc<StateVarParserFsmFrameEvent>, default_return: Option<StateVarParserFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl StateVarParserFsm {
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<StateVarParserFsmFrameEvent>) {
        ...
        pub fn do_parse(&mut self) {
            let __e = alloc::rc::Rc::new(StateVarParserFsmFrameEvent::DoParse {});
            let mut __ctx = StateVarParserFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
...
pub use _state_var_parser_fsm_framec::*;
