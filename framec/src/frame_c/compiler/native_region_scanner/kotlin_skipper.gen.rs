...
mod _kotlin_syntax_skipper_fsm_framec {
    ...
    impl KotlinSyntaxSkipperFsmCompartment {
        fn new(state: &str) -> Self {
            let state_context = match state {
                ...
                _ => KotlinSyntaxSkipperFsmStateContext::__NoContext,
            };
            Self {
    ...
    impl KotlinSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::FrameEnter {});
        ...
        fn __prepareEnter(&mut self, leaf: &str) -> KotlinSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<KotlinSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::FrameExit {});
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::FrameEnter {});
