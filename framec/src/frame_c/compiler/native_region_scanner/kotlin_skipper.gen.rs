...
mod _kotlin_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    ...
    struct KotlinSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<KotlinSyntaxSkipperFsmFrameEvent>,
        _return: Option<KotlinSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, KotlinSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl KotlinSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<KotlinSyntaxSkipperFsmFrameEvent>, default_return: Option<KotlinSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl KotlinSyntaxSkipperFsm {
        ...
        pub fn __create() -> Self {
            ...
            let __e = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::FrameEnter { args: c.__compartment.enter_args.clone() });
            let __ctx = KotlinSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        fn __prepareEnter(&mut self, leaf: &str, enter_args: Vec<alloc::rc::Rc<dyn core::any::Any>>) -> KotlinSyntaxSkipperFsmCompartment {
        ...
        fn __kernel(&mut self, __e: &alloc::rc::Rc<KotlinSyntaxSkipperFsmFrameEvent>) {
            ...
            while self.__next_compartment.is_some() {
                ...
                let exit_event = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::FrameExit { args: exit_args });
                ...
                match self.__compartment.forward_event.take() {
                    None => {
                        ...
                        let enter_event = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::FrameEnter { args: enter_args });
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<KotlinSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = KotlinSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = KotlinSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = KotlinSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(KotlinSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = KotlinSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _kotlin_syntax_skipper_fsm_framec::*;
