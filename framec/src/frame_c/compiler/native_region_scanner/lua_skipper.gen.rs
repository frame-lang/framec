...
mod _lua_syntax_skipper_fsm_framec {
    use super::*;
    extern crate alloc;
    #[derive(Clone, Debug)]
    ...
    struct LuaSyntaxSkipperFsmFrameContext {
        event: alloc::rc::Rc<LuaSyntaxSkipperFsmFrameEvent>,
        _return: Option<LuaSyntaxSkipperFsmFrameReturn>,
        _data: alloc::collections::BTreeMap<String, LuaSyntaxSkipperFsmFrameValue>,
        _transitioned: bool,
    }

    impl LuaSyntaxSkipperFsmFrameContext {
        fn new(event: alloc::rc::Rc<LuaSyntaxSkipperFsmFrameEvent>, default_return: Option<LuaSyntaxSkipperFsmFrameReturn>) -> Self {
            Self {
                event,
    ...
    impl LuaSyntaxSkipperFsm {
        ...
        fn __router(&mut self, __e: &alloc::rc::Rc<LuaSyntaxSkipperFsmFrameEvent>) {
        ...
        pub fn do_skip_comment(&mut self) {
            let __e = alloc::rc::Rc::new(LuaSyntaxSkipperFsmFrameEvent::DoSkipComment {});
            let mut __ctx = LuaSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
        ...
        pub fn do_skip_string(&mut self) {
            let __e = alloc::rc::Rc::new(LuaSyntaxSkipperFsmFrameEvent::DoSkipString {});
            let mut __ctx = LuaSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_find_line_end(&mut self) {
            let __e = alloc::rc::Rc::new(LuaSyntaxSkipperFsmFrameEvent::DoFindLineEnd {});
            let mut __ctx = LuaSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
        ...
        pub fn do_balanced_paren_end(&mut self) {
            let __e = alloc::rc::Rc::new(LuaSyntaxSkipperFsmFrameEvent::DoBalancedParenEnd {});
            let mut __ctx = LuaSyntaxSkipperFsmFrameContext::new(alloc::rc::Rc::clone(&__e), None);
            self._context_stack.push(__ctx);
            self.__kernel(&__e);
            self._context_stack.pop();
...
pub use _lua_syntax_skipper_fsm_framec::*;
