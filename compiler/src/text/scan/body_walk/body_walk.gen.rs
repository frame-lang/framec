...
impl<'a> BodyWalk<'a> {
    pub fn over(src: &'a [u8], target: Target, limit: usize) -> Self {
        ...
        BodyWalk { src, cursor: 0, compartment, stack: Vec::new(), target: target, limit: limit, depth: 0, starts: Vec::new() }
    }
